...
\Cref{fig:ressat-quantile-random} shows the quantile plots of the SSAT instances
derived from the random $k$-CNF formulas.
\Cref{fig:ressat-quantile-cputime-random} shows the CPU-time quantile plot.
\Cref{fig:ressat-quantile-memory-random} shows the memory-usage quantile plot.
...
\Cref{fig:ressat-quantile-cputime-strategic} shows the CPU-time quantile plot.
\Cref{fig:ressat-quantile-memory-strategic} shows the memory-usage quantile plot.

\Cref{fig:ressat-quantile-cputime-strategic} shows the CPU-time quantile plot of the SSAT instances
derived from the strategic-company QBFs.
\Cref{fig:ressat-quantile-memory-strategic} shows the memory-usage quantile plot of the SSAT instances
derived from the strategic-company QBFs.
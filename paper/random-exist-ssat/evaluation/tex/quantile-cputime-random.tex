...
\begin{tikzpicture}
    \begin{semilogyaxis}[
        ...
        \addplot+ table {random-exist-ssat/evaluation/csv/dcssat.default.Random.quantile.cputime.csv};
        \addplot+ table {random-exist-ssat/evaluation/csv/ressat.bare-Cachet.Random.quantile.cputime.csv};
        \addplot+ table {random-exist-ssat/evaluation/csv/ressat.minimize-Cachet.Random.quantile.cputime.csv};
    \end{semilogyaxis}
\end{tikzpicture}

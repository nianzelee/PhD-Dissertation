...
\begin{tikzpicture}
    \begin{semilogyaxis}[
        ...
        \addplot+ table {../csv/dcssat.default.Strategic.quantile.memory.csv};
        \addplot+ table {../csv/ressat.bare-Cachet.Strategic.quantile.memory.csv};
        \addplot+ table {../csv/ressat.minimize-Cachet.Strategic.quantile.memory.csv};
    \end{semilogyaxis}
\end{tikzpicture}

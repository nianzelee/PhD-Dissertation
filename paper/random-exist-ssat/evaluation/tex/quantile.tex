...
\begin{tikzpicture}
  \begin{semilogyaxis}[
    ...
    \addplot+ table {random-exist-ssat/evaluation/csv/dcssat.default.quantile.csv};
    \addplot+ table {random-exist-ssat/evaluation/csv/ressat.bare-Cachet.quantile.csv};
    \addplot+ table {random-exist-ssat/evaluation/csv/ressat.minimize-Cachet.quantile.csv};
  \end{semilogyaxis}
\end{tikzpicture}

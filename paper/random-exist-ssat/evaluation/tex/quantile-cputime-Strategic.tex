...
\begin{tikzpicture}
    \begin{semilogyaxis}[
        ...
        \addplot+ table {../csv/dcssat.default.Strategic.quantile.cputime.csv};
        \addplot+ table {../csv/ressat.bare-Cachet.Strategic.quantile.cputime.csv};
        \addplot+ table {../csv/ressat.minimize-Cachet.Strategic.quantile.cputime.csv};
    \end{semilogyaxis}
\end{tikzpicture}

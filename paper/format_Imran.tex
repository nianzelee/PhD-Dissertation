...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\theorembodyfont{\rmfamily}\newtheorem{Pro}{{\textbf Proposition}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{The}{{\textbf Theorem}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{Def}{{\textbf Definition}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{Cor}{{\textbf Corollary}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{Lem}{{\textbf Lemma}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{Exp}{{\textbf Example}}[chapter]}
...
{\theorembodyfont{\rmfamily}\newtheorem{fact}{{\textbf Fact}}[chapter]}
{\theorembodyfont{\rmfamily}\newtheorem{proof}{{\textbf Proof}}[chapter]}

%{\theorembodyfont{\rmfamily}\newtheorem{Def}[Pro]{{\textbf Definition}}}
%{\theorembodyfont{\rmfamily}\newtheorem{Cor}[Pro]{{\textbf Corollary}}}
%{\theorembodyfont{\rmfamily}\newtheorem{Lem}[Pro]{{\textbf Lemma}}}
...
%\def\begin{proof}\textbf{Proof}. }
%\def\end{proof}{\hfill$\Box$}

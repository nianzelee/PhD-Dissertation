...
\settitle
{我的博士論文}
{My Awesome Doctoral Dissertation}
...
% constant words
\newcommand{\biocham}{Biocham}
\newcommand{\zeroultra}{zero-order ultrasensitivity}
\newcommand{\prolog}{Prolog}
\newcommand{\boolT}{\lit{true}}
\newcommand{\boolF}{\lit{false}}
\newcommand{\mm}{Michaelis-Menten}
\newcommand{\gk}{Goldbeter-Koshland}
\makeatletter
\newcommand{\ma}{\@ifstar{\ma@star}{\ma@nostar}}
\newcommand{\ma@star}{Mass-action}
\newcommand{\ma@nostar}{mass-action}
\makeatother
% end constant words

% chemical related commands
\newcommand{\species}[1]{\ensuremath{\ce{\uppercase{#1}}}}
\newcommand{\conc}[2]{[\ensuremath{\species{#1}_{#2}}]}
\newcommand{\catconst}[1]{k_{#1}}
% end chemical related commands
...
% expression related commands
\newcommand{\posvar}[1]{\ensuremath{#1^+}}
\newcommand{\negvar}[1]{\ensuremath{#1^-}}
\newcommand{\expr}[1]{\texttt{#1}}
\newcommand{\mathterm}[1]{\mathit{#1}}
\newcommand{\var}[1]{\ensuremath{\mathterm{\lowercase{#1}}}}
\newcommand{\modified}[1]{\textcolor{red}{#1}}
% end expression related commands

% typeset for different semantics
\newcommand{\term}[1]{\emph{#1}}
\newcommand{\op}[1]{\emph{#1}}
\newcommand{\biochamcmd}[1]{\texttt{#1}}
\newcommand{\code}[1]{\lstinline!#1!}
\newcommand{\block}[1]{\emph{#1}}
\newcommand{\signal}[1]{\texttt{#1}}
\newcommand{\switchstate}[1]{\ensuremath{#1}}
% end typeset for different semantics

...
We focus on random-exist and exist-random quantified fragments of SSAT formulas, which have important AI applications.

The random-exist quantified SSAT formula is of the form $\Phi=\random{} X \exists Y.\phi$, which is the counterpart of the forall-exist QBF.
...
In addition to devising new algorithms, we further identify important applications of random-exist and exist-random quantified SSAT formulas in the regime of emerging computational paradigm of VLSI systems.

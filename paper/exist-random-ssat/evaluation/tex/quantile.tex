...
\begin{tikzpicture}
  \begin{semilogyaxis}[
    ...
    \addplot+ table {exist-random-ssat/evaluation/csv/dcssat.default.quantile.csv};
    \addplot+ table {exist-random-ssat/evaluation/csv/erssat.bare-BDD.quantile.csv};
    \addplot+ table {exist-random-ssat/evaluation/csv/erssat.default-BDD.quantile.csv};
  \end{semilogyaxis}
\end{tikzpicture}

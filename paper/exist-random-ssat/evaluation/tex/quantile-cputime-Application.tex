...
\begin{tikzpicture}
    \begin{semilogyaxis}[
        ...
        \addplot+ table {../csv/dcssat.default.Application.quantile.cputime.csv};
        \addplot+ table {../csv/erssat.bare-BDD.Application.quantile.cputime.csv};
        \addplot+ table {../csv/erssat.default-BDD.Application.quantile.cputime.csv};
    \end{semilogyaxis}
\end{tikzpicture}

...
\begin{tikzpicture}
    \begin{semilogyaxis}[
        ...
        \addplot+ table {exist-random-ssat/evaluation/csv/dcssat.default.Random.quantile.memory.csv};
        \addplot+ table {exist-random-ssat/evaluation/csv/erssat.bare-BDD.Random.quantile.memory.csv};
        \addplot+ table {exist-random-ssat/evaluation/csv/erssat.default-BDD.Random.quantile.memory.csv};
    \end{semilogyaxis}
\end{tikzpicture}

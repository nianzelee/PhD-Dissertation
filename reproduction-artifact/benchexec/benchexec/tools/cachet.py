...
class Tool(benchexec.tools.template.BaseTool2):
    """
    Tool info for Cachet: Combining Component Caching and Clause Learning for Effective Model Counting
    URL: https://www.cs.rochester.edu/u/kautz/papers/modelcount-sat04.pdf
    """

    def executable(self, tool_locator):
        return tool_locator.find_executable("cachet", subdir="bin")
    ...
    def cmdline(self, executable, options, task, rlimits):
        if task.single_input_file.endswith(".pec"):
            new_file_name = os.path.splitext(task.single_input_file)[0] + "-wmc.wcnf"
